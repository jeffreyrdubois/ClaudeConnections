...
MCP server exposing Ancestry.com family tree data (via GEDCOM) to Claude —
browse people, families, ancestors, and descendants.

Runs as a standalone Docker container on host port **3002** (the app listens on
